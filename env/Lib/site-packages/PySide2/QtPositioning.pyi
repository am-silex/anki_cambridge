...
class QGeoAreaMonitorSource(PySide2.QtCore.QObject):
    ...
    PersistentAreaMonitorFeature: AreaMonitorFeature = ... # 0x1
    AnyAreaMonitorFeature    : AreaMonitorFeature = ... # -0x1

    class AreaMonitorFeatures(object): ...

    class Error(object): ...
    AccessError              : Error = ... # 0x0
    InsufficientPositionInfo : Error = ... # 0x1
    UnknownSourceError       : Error = ... # 0x2
    NoError                  : Error = ... # 0x3
...
class QGeoCoordinate(Shiboken.Object):
    ...
    Degrees                  : CoordinateFormat = ... # 0x0
    DegreesWithHemisphere    : CoordinateFormat = ... # 0x1
    DegreesMinutes           : CoordinateFormat = ... # 0x2
    DegreesMinutesWithHemisphere: CoordinateFormat = ... # 0x3
    DegreesMinutesSeconds    : CoordinateFormat = ... # 0x4
    DegreesMinutesSecondsWithHemisphere: CoordinateFormat = ... # 0x5

    class CoordinateType(object): ...
    InvalidCoordinate        : CoordinateType = ... # 0x0
    Coordinate2D             : CoordinateType = ... # 0x1
    Coordinate3D             : CoordinateType = ... # 0x2
...
class QGeoPositionInfo(Shiboken.Object):
    ...
    Direction                : Attribute = ... # 0x0
    GroundSpeed              : Attribute = ... # 0x1
    VerticalSpeed            : Attribute = ... # 0x2
    MagneticVariation        : Attribute = ... # 0x3
    HorizontalAccuracy       : Attribute = ... # 0x4
    VerticalAccuracy         : Attribute = ... # 0x5
...
class QGeoPositionInfoSource(PySide2.QtCore.QObject):
    ...
    class Error(object): ...
    AccessError              : Error = ... # 0x0
    ClosedError              : Error = ... # 0x1
    UnknownSourceError       : Error = ... # 0x2
    NoError                  : Error = ... # 0x3

    class PositioningMethod(object): ...
    NoPositioningMethods     : PositioningMethod = ... # 0x0
    SatellitePositioningMethods: PositioningMethod = ... # 0xff
    NonSatellitePositioningMethods: PositioningMethod = ... # -0x100
    AllPositioningMethods    : PositioningMethod = ... # -0x1
...
class QGeoSatelliteInfo(Shiboken.Object):
    ...
    class Attribute(object): ...
    Elevation                : Attribute = ... # 0x0
    Azimuth                  : Attribute = ... # 0x1

    class SatelliteSystem(object): ...
    Undefined                : SatelliteSystem = ... # 0x0
    GPS                      : SatelliteSystem = ... # 0x1
    GLONASS                  : SatelliteSystem = ... # 0x2
...
class QGeoShape(Shiboken.Object):
    ...
    UnknownType              : ShapeType = ... # 0x0
    RectangleType            : ShapeType = ... # 0x1
    CircleType               : ShapeType = ... # 0x2
    PathType                 : ShapeType = ... # 0x3
    PolygonType              : ShapeType = ... # 0x4
...
class QNmeaPositionInfoSource(PySide2.QtPositioning.QGeoPositionInfoSource):
    ...
    RealTimeMode             : UpdateMode = ... # 0x1
    SimulationMode           : UpdateMode = ... # 0x2
