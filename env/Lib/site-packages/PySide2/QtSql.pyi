...
class QSql(Shiboken.Object):
    ...
    BeforeFirstRow           : Location = ... # -0x1
    AfterLastRow             : Location = ... # -0x2

    class NumericalPrecisionPolicy(object): ...
    LowPrecisionInt32        : NumericalPrecisionPolicy = ... # 0x1
    LowPrecisionInt64        : NumericalPrecisionPolicy = ... # 0x2
    LowPrecisionDouble       : NumericalPrecisionPolicy = ... # 0x4
    HighPrecision            : NumericalPrecisionPolicy = ... # 0x0

    class ParamType(object): ...

    class ParamTypeFlag(object): ...
    In                       : ParamTypeFlag = ... # 0x1
    Out                      : ParamTypeFlag = ... # 0x2
    InOut                    : ParamTypeFlag = ... # 0x3
    Binary                   : ParamTypeFlag = ... # 0x4

    class TableType(object): ...
    Tables                   : TableType = ... # 0x1
    SystemTables             : TableType = ... # 0x2
    Views                    : TableType = ... # 0x4
    AllTables                : TableType = ... # 0xff
...
class QSqlDriver(PySide2.QtCore.QObject):
    ...
    UnknownDbms              : DbmsType = ... # 0x0
    MSSqlServer              : DbmsType = ... # 0x1
    MySqlServer              : DbmsType = ... # 0x2
    PostgreSQL               : DbmsType = ... # 0x3
    Oracle                   : DbmsType = ... # 0x4
    Sybase                   : DbmsType = ... # 0x5
    SQLite                   : DbmsType = ... # 0x6
    Interbase                : DbmsType = ... # 0x7
    DB2                      : DbmsType = ... # 0x8

    class DriverFeature(object): ...
    Transactions             : DriverFeature = ... # 0x0
    QuerySize                : DriverFeature = ... # 0x1
    BLOB                     : DriverFeature = ... # 0x2
    Unicode                  : DriverFeature = ... # 0x3
    PreparedQueries          : DriverFeature = ... # 0x4
    NamedPlaceholders        : DriverFeature = ... # 0x5
    PositionalPlaceholders   : DriverFeature = ... # 0x6
    LastInsertId             : DriverFeature = ... # 0x7
    BatchOperations          : DriverFeature = ... # 0x8
    SimpleLocking            : DriverFeature = ... # 0x9
    LowPrecisionNumbers      : DriverFeature = ... # 0xa
    EventNotifications       : DriverFeature = ... # 0xb
    FinishQuery              : DriverFeature = ... # 0xc
    MultipleResultSets       : DriverFeature = ... # 0xd
    CancelQuery              : DriverFeature = ... # 0xe

    class IdentifierType(object): ...
    FieldName                : IdentifierType = ... # 0x0
    TableName                : IdentifierType = ... # 0x1

    class NotificationSource(object): ...
    UnknownSource            : NotificationSource = ... # 0x0
    SelfSource               : NotificationSource = ... # 0x1
    OtherSource              : NotificationSource = ... # 0x2

    class StatementType(object): ...
    WhereStatement           : StatementType = ... # 0x0
    SelectStatement          : StatementType = ... # 0x1
    UpdateStatement          : StatementType = ... # 0x2
    InsertStatement          : StatementType = ... # 0x3
    DeleteStatement          : StatementType = ... # 0x4
...
class QSqlError(Shiboken.Object):
    ...
    ConnectionError          : ErrorType = ... # 0x1
    StatementError           : ErrorType = ... # 0x2
    TransactionError         : ErrorType = ... # 0x3
    UnknownError             : ErrorType = ... # 0x4
...
class QSqlField(Shiboken.Object):
    ...
    Unknown                  : RequiredStatus = ... # -0x1
    Optional                 : RequiredStatus = ... # 0x0
    Required                 : RequiredStatus = ... # 0x1
...
class QSqlQuery(Shiboken.Object):
    ...
    ValuesAsRows             : BatchExecutionMode = ... # 0x0
    ValuesAsColumns          : BatchExecutionMode = ... # 0x1
...
class QSqlRelationalTableModel(PySide2.QtSql.QSqlTableModel):
    ...
    InnerJoin                : JoinMode = ... # 0x0
    LeftJoin                 : JoinMode = ... # 0x1
...
class QSqlResult(Shiboken.Object):
    ...
    PositionalBinding        : BindingSyntax = ... # 0x0
    NamedBinding             : BindingSyntax = ... # 0x1
...
class QSqlTableModel(PySide2.QtSql.QSqlQueryModel):
    ...
    OnFieldChange            : EditStrategy = ... # 0x0
    OnRowChange              : EditStrategy = ... # 0x1
    OnManualSubmit           : EditStrategy = ... # 0x2
