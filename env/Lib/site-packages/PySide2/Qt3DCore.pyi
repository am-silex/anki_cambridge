...
class Qt3DCore(Shiboken.Object):
    ...
    NodeCreated              : ChangeFlag = ... # 0x1
    NodeDeleted              : ChangeFlag = ... # 0x2
    PropertyUpdated          : ChangeFlag = ... # 0x4
    PropertyValueAdded       : ChangeFlag = ... # 0x8
    PropertyValueRemoved     : ChangeFlag = ... # 0x10
    ComponentAdded           : ChangeFlag = ... # 0x20
    ComponentRemoved         : ChangeFlag = ... # 0x40
    CommandRequested         : ChangeFlag = ... # 0x80
    CallbackTriggered        : ChangeFlag = ... # 0x100
    AllChanges               : ChangeFlag = ... # -0x1
    ...
    class QNode(PySide2.QtCore.QObject):
        ...
        TrackFinalValues         : PropertyTrackingMode = ... # 0x0
        DontTrackValues          : PropertyTrackingMode = ... # 0x1
        TrackAllValues           : PropertyTrackingMode = ... # 0x2
    ...
    class QSceneChange(Shiboken.Object):
        ...
        BackendNodes             : DeliveryFlag = ... # 0x1
        Nodes                    : DeliveryFlag = ... # 0x10
        DeliverToAll             : DeliveryFlag = ... # 0x11
