...
class QDomImplementation(Shiboken.Object):
    ...
    AcceptInvalidChars       : InvalidDataPolicy = ... # 0x0
    DropInvalidChars         : InvalidDataPolicy = ... # 0x1
    ReturnNullNode           : InvalidDataPolicy = ... # 0x2
...
class QDomNode(Shiboken.Object):
    ...
    EncodingFromDocument     : EncodingPolicy = ... # 0x1
    EncodingFromTextStream   : EncodingPolicy = ... # 0x2

    class NodeType(object): ...
    ElementNode              : NodeType = ... # 0x1
    AttributeNode            : NodeType = ... # 0x2
    TextNode                 : NodeType = ... # 0x3
    CDATASectionNode         : NodeType = ... # 0x4
    EntityReferenceNode      : NodeType = ... # 0x5
    EntityNode               : NodeType = ... # 0x6
    ProcessingInstructionNode: NodeType = ... # 0x7
    CommentNode              : NodeType = ... # 0x8
    DocumentNode             : NodeType = ... # 0x9
    DocumentTypeNode         : NodeType = ... # 0xa
    DocumentFragmentNode     : NodeType = ... # 0xb
    NotationNode             : NodeType = ... # 0xc
    BaseNode                 : NodeType = ... # 0x15
    CharacterDataNode        : NodeType = ... # 0x16
