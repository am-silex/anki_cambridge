...
class QtCharts(Shiboken.Object):
    ...
    class QAbstractAxis(PySide2.QtCore.QObject):
        ...
        AxisTypeNoAxis           : AxisType = ... # 0x0
        AxisTypeValue            : AxisType = ... # 0x1
        AxisTypeBarCategory      : AxisType = ... # 0x2
        AxisTypeCategory         : AxisType = ... # 0x4
        AxisTypeDateTime         : AxisType = ... # 0x8
        AxisTypeLogValue         : AxisType = ... # 0x10
    ...
    class QAbstractBarSeries(PySide2.QtCharts.QtCharts.QAbstractSeries):
        ...
        LabelsCenter             : LabelsPosition = ... # 0x0
        LabelsInsideEnd          : LabelsPosition = ... # 0x1
        LabelsInsideBase         : LabelsPosition = ... # 0x2
        LabelsOutsideEnd         : LabelsPosition = ... # 0x3
        @typing.overload
    ...
    class QAbstractSeries(PySide2.QtCore.QObject):
        ...
        SeriesTypeLine           : SeriesType = ... # 0x0
        SeriesTypeArea           : SeriesType = ... # 0x1
        SeriesTypeBar            : SeriesType = ... # 0x2
        SeriesTypeStackedBar     : SeriesType = ... # 0x3
        SeriesTypePercentBar     : SeriesType = ... # 0x4
        SeriesTypePie            : SeriesType = ... # 0x5
        SeriesTypeScatter        : SeriesType = ... # 0x6
        SeriesTypeSpline         : SeriesType = ... # 0x7
        SeriesTypeHorizontalBar  : SeriesType = ... # 0x8
        SeriesTypeHorizontalStackedBar: SeriesType = ... # 0x9
        SeriesTypeHorizontalPercentBar: SeriesType = ... # 0xa
        SeriesTypeBoxPlot        : SeriesType = ... # 0xb
        SeriesTypeCandlestick    : SeriesType = ... # 0xc
    ...
    class QBoxSet(PySide2.QtCore.QObject):
        ...
        LowerExtreme             : ValuePositions = ... # 0x0
        LowerQuartile            : ValuePositions = ... # 0x1
        Median                   : ValuePositions = ... # 0x2
        UpperQuartile            : ValuePositions = ... # 0x3
        UpperExtreme             : ValuePositions = ... # 0x4
    ...
    class QCategoryAxis(PySide2.QtCharts.QtCharts.QValueAxis):
        ...
        AxisLabelsPositionCenter : AxisLabelsPosition = ... # 0x0
        AxisLabelsPositionOnValue: AxisLabelsPosition = ... # 0x1
    ...
    class QChart(PySide2.QtWidgets.QGraphicsWidget):
        ...
        NoAnimation              : AnimationOption = ... # 0x0
        GridAxisAnimations       : AnimationOption = ... # 0x1
        SeriesAnimations         : AnimationOption = ... # 0x2
        AllAnimations            : AnimationOption = ... # 0x3

        class AnimationOptions(object): ...

        class ChartTheme(object): ...
        ChartThemeLight          : ChartTheme = ... # 0x0
        ChartThemeBlueCerulean   : ChartTheme = ... # 0x1
        ChartThemeDark           : ChartTheme = ... # 0x2
        ChartThemeBrownSand      : ChartTheme = ... # 0x3
        ChartThemeBlueNcs        : ChartTheme = ... # 0x4
        ChartThemeHighContrast   : ChartTheme = ... # 0x5
        ChartThemeBlueIcy        : ChartTheme = ... # 0x6
        ChartThemeQt             : ChartTheme = ... # 0x7

        class ChartType(object): ...
        ChartTypeUndefined       : ChartType = ... # 0x0
        ChartTypeCartesian       : ChartType = ... # 0x1
        ChartTypePolar           : ChartType = ... # 0x2
    ...
    class QChartView(PySide2.QtWidgets.QGraphicsView):
        ...
        NoRubberBand             : RubberBand = ... # 0x0
        VerticalRubberBand       : RubberBand = ... # 0x1
        HorizontalRubberBand     : RubberBand = ... # 0x2
        RectangleRubberBand      : RubberBand = ... # 0x3
    ...
    class QLegend(PySide2.QtWidgets.QGraphicsWidget):
        ...
        MarkerShapeDefault       : MarkerShape = ... # 0x0
        MarkerShapeRectangle     : MarkerShape = ... # 0x1
        MarkerShapeCircle        : MarkerShape = ... # 0x2
        MarkerShapeFromSeries    : MarkerShape = ... # 0x3
        def alignment(self) -> PySide2.QtCore.Qt.Alignment: ...
    ...
    class QLegendMarker(PySide2.QtCore.QObject):
        ...
        LegendMarkerTypeArea     : LegendMarkerType = ... # 0x0
        LegendMarkerTypeBar      : LegendMarkerType = ... # 0x1
        LegendMarkerTypePie      : LegendMarkerType = ... # 0x2
        LegendMarkerTypeXY       : LegendMarkerType = ... # 0x3
        LegendMarkerTypeBoxPlot  : LegendMarkerType = ... # 0x4
        LegendMarkerTypeCandlestick: LegendMarkerType = ... # 0x5
        def brush(self) -> PySide2.QtGui.QBrush: ...
        def font(self) -> PySide2.QtGui.QFont: ...
        def isVisible(self) -> bool: ...
        def label(self) -> str: ...
    ...
    class QPieSlice(PySide2.QtCore.QObject):
        ...
        LabelOutside             : LabelPosition = ... # 0x0
        LabelInsideHorizontal    : LabelPosition = ... # 0x1
        LabelInsideTangential    : LabelPosition = ... # 0x2
        LabelInsideNormal        : LabelPosition = ... # 0x3
    ...
    class QPolarChart(PySide2.QtCharts.QtCharts.QChart):
        ...
        PolarOrientationRadial   : PolarOrientation = ... # 0x1
        PolarOrientationAngular  : PolarOrientation = ... # 0x2
    ...
    class QScatterSeries(PySide2.QtCharts.QtCharts.QXYSeries):
        ...
        class MarkerShape(object): ...
        MarkerShapeCircle        : MarkerShape = ... # 0x0
        MarkerShapeRectangle     : MarkerShape = ... # 0x1
