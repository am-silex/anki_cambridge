...
class QtDataVisualization(Shiboken.Object):
    ...
    class Q3DCamera(PySide2.QtDataVisualization.QtDataVisualization.Q3DObject):
        ...
        CameraPresetNone         : CameraPreset = ... # -0x1
        CameraPresetFrontLow     : CameraPreset = ... # 0x0
        CameraPresetFront        : CameraPreset = ... # 0x1
        CameraPresetFrontHigh    : CameraPreset = ... # 0x2
        CameraPresetLeftLow      : CameraPreset = ... # 0x3
        CameraPresetLeft         : CameraPreset = ... # 0x4
        CameraPresetLeftHigh     : CameraPreset = ... # 0x5
        CameraPresetRightLow     : CameraPreset = ... # 0x6
        CameraPresetRight        : CameraPreset = ... # 0x7
        CameraPresetRightHigh    : CameraPreset = ... # 0x8
        CameraPresetBehindLow    : CameraPreset = ... # 0x9
        CameraPresetBehind       : CameraPreset = ... # 0xa
        CameraPresetBehindHigh   : CameraPreset = ... # 0xb
        CameraPresetIsometricLeft: CameraPreset = ... # 0xc
        CameraPresetIsometricLeftHigh: CameraPreset = ... # 0xd
        CameraPresetIsometricRight: CameraPreset = ... # 0xe
        CameraPresetIsometricRightHigh: CameraPreset = ... # 0xf
        CameraPresetDirectlyAbove: CameraPreset = ... # 0x10
        CameraPresetDirectlyAboveCW45: CameraPreset = ... # 0x11
        CameraPresetDirectlyAboveCCW45: CameraPreset = ... # 0x12
        CameraPresetFrontBelow   : CameraPreset = ... # 0x13
        CameraPresetLeftBelow    : CameraPreset = ... # 0x14
        CameraPresetRightBelow   : CameraPreset = ... # 0x15
        CameraPresetBehindBelow  : CameraPreset = ... # 0x16
        CameraPresetDirectlyBelow: CameraPreset = ... # 0x17
    ...
    class Q3DTheme(PySide2.QtCore.QObject):
        ...
        ColorStyleUniform        : ColorStyle = ... # 0x0
        ColorStyleObjectGradient : ColorStyle = ... # 0x1
        ColorStyleRangeGradient  : ColorStyle = ... # 0x2

        class Theme(object): ...
        ThemeQt                  : Theme = ... # 0x0
        ThemePrimaryColors       : Theme = ... # 0x1
        ThemeDigia               : Theme = ... # 0x2
        ThemeStoneMoss           : Theme = ... # 0x3
        ThemeArmyBlue            : Theme = ... # 0x4
        ThemeRetro               : Theme = ... # 0x5
        ThemeEbony               : Theme = ... # 0x6
        ThemeIsabelle            : Theme = ... # 0x7
        ThemeUserDefined         : Theme = ... # 0x8
    ...
    class QAbstract3DAxis(PySide2.QtCore.QObject):
        ...
        AxisOrientationNone      : AxisOrientation = ... # 0x0
        AxisOrientationX         : AxisOrientation = ... # 0x1
        AxisOrientationY         : AxisOrientation = ... # 0x2
        AxisOrientationZ         : AxisOrientation = ... # 0x4

        class AxisType(object): ...
        AxisTypeNone             : AxisType = ... # 0x0
        AxisTypeCategory         : AxisType = ... # 0x1
        AxisTypeValue            : AxisType = ... # 0x2
    ...
    class QAbstract3DGraph(PySide2.QtGui.QWindow):
        ...
        ElementNone              : ElementType = ... # 0x0
        ElementSeries            : ElementType = ... # 0x1
        ElementAxisXLabel        : ElementType = ... # 0x2
        ElementAxisYLabel        : ElementType = ... # 0x3
        ElementAxisZLabel        : ElementType = ... # 0x4
        ElementCustomItem        : ElementType = ... # 0x5

        class OptimizationHint(object): ...
        OptimizationDefault      : OptimizationHint = ... # 0x0
        OptimizationStatic       : OptimizationHint = ... # 0x1

        class OptimizationHints(object): ...

        class SelectionFlag(object): ...
        SelectionNone            : SelectionFlag = ... # 0x0
        SelectionItem            : SelectionFlag = ... # 0x1
        SelectionRow             : SelectionFlag = ... # 0x2
        SelectionItemAndRow      : SelectionFlag = ... # 0x3
        SelectionColumn          : SelectionFlag = ... # 0x4
        SelectionItemAndColumn   : SelectionFlag = ... # 0x5
        SelectionRowAndColumn    : SelectionFlag = ... # 0x6
        SelectionItemRowAndColumn: SelectionFlag = ... # 0x7
        SelectionSlice           : SelectionFlag = ... # 0x8
        SelectionMultiSeries     : SelectionFlag = ... # 0x10

        class SelectionFlags(object): ...

        class ShadowQuality(object): ...
        ShadowQualityNone        : ShadowQuality = ... # 0x0
        ShadowQualityLow         : ShadowQuality = ... # 0x1
        ShadowQualityMedium      : ShadowQuality = ... # 0x2
        ShadowQualityHigh        : ShadowQuality = ... # 0x3
        ShadowQualitySoftLow     : ShadowQuality = ... # 0x4
        ShadowQualitySoftMedium  : ShadowQuality = ... # 0x5
        ShadowQualitySoftHigh    : ShadowQuality = ... # 0x6
    ...
    class QAbstract3DInputHandler(PySide2.QtCore.QObject):
        ...
        InputViewNone            : InputView = ... # 0x0
        InputViewOnPrimary       : InputView = ... # 0x1
        InputViewOnSecondary     : InputView = ... # 0x2
    ...
    class QAbstract3DSeries(PySide2.QtCore.QObject):
        ...
        class Mesh(object): ...
        MeshUserDefined          : Mesh = ... # 0x0
        MeshBar                  : Mesh = ... # 0x1
        MeshCube                 : Mesh = ... # 0x2
        MeshPyramid              : Mesh = ... # 0x3
        MeshCone                 : Mesh = ... # 0x4
        MeshCylinder             : Mesh = ... # 0x5
        MeshBevelBar             : Mesh = ... # 0x6
        MeshBevelCube            : Mesh = ... # 0x7
        MeshSphere               : Mesh = ... # 0x8
        MeshMinimal              : Mesh = ... # 0x9
        MeshArrow                : Mesh = ... # 0xa
        MeshPoint                : Mesh = ... # 0xb

        class SeriesType(object): ...
        SeriesTypeNone           : SeriesType = ... # 0x0
        SeriesTypeBar            : SeriesType = ... # 0x1
        SeriesTypeScatter        : SeriesType = ... # 0x2
        SeriesTypeSurface        : SeriesType = ... # 0x4
    ...
    class QAbstractDataProxy(PySide2.QtCore.QObject):
        ...
        DataTypeNone             : DataType = ... # 0x0
        DataTypeBar              : DataType = ... # 0x1
        DataTypeScatter          : DataType = ... # 0x2
        DataTypeSurface          : DataType = ... # 0x4
    ...
    class QItemModelBarDataProxy(PySide2.QtDataVisualization.QtDataVisualization.QBarDataProxy):
        ...
        MMBFirst                 : MultiMatchBehavior = ... # 0x0
        MMBLast                  : MultiMatchBehavior = ... # 0x1
        MMBAverage               : MultiMatchBehavior = ... # 0x2
        MMBCumulative            : MultiMatchBehavior = ... # 0x3
        ...
        @typing.overload
        def __init__(self, itemModel:PySide2.QtCore.QAbstractItemModel, rowRole:str, columnRole:str, valueRole:str, rotationRole:str, rowCategories:typing.List, columnCategories:typing.List, parent:typing.Optional[PySide2.QtCore.QObject]=...): ...
        @typing.overload
        def __init__(self, itemModel:PySide2.QtCore.QAbstractItemModel, rowRole:str, columnRole:str, valueRole:str, rowCategories:typing.List, columnCategories:typing.List, parent:typing.Optional[PySide2.QtCore.QObject]=...): ...
        @typing.overload
    ...
    class QItemModelSurfaceDataProxy(PySide2.QtDataVisualization.QtDataVisualization.QSurfaceDataProxy):
        ...
        MMBLast                  : MultiMatchBehavior = ... # 0x1
        MMBAverage               : MultiMatchBehavior = ... # 0x2
        MMBCumulativeY           : MultiMatchBehavior = ... # 0x3
        ...
        @typing.overload
        def __init__(self, itemModel:PySide2.QtCore.QAbstractItemModel, rowRole:str, columnRole:str, xPosRole:str, yPosRole:str, zPosRole:str, rowCategories:typing.List, columnCategories:typing.List, parent:typing.Optional[PySide2.QtCore.QObject]=...): ...
        @typing.overload
        ...
        @typing.overload
        def __init__(self, itemModel:PySide2.QtCore.QAbstractItemModel, rowRole:str, columnRole:str, yPosRole:str, rowCategories:typing.List, columnCategories:typing.List, parent:typing.Optional[PySide2.QtCore.QObject]=...): ...
        @typing.overload
    ...
    class QSurface3DSeries(PySide2.QtDataVisualization.QtDataVisualization.QAbstract3DSeries):
        ...
        DrawWireframe            : DrawFlag = ... # 0x1
        DrawSurface              : DrawFlag = ... # 0x2
        DrawSurfaceAndWireframe  : DrawFlag = ... # 0x3
