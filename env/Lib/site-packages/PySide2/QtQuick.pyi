...
class QQuickItem(PySide2.QtCore.QObject, PySide2.QtQml.QQmlParserStatus):
    ...
    class Flag(object): ...
    ItemClipsChildrenToShape : Flag = ... # 0x1
    ItemAcceptsInputMethod   : Flag = ... # 0x2
    ItemIsFocusScope         : Flag = ... # 0x4
    ItemHasContents          : Flag = ... # 0x8
    ItemAcceptsDrops         : Flag = ... # 0x10

    class Flags(object): ...

    class ItemChange(object): ...
    ItemChildAddedChange     : ItemChange = ... # 0x0
    ItemChildRemovedChange   : ItemChange = ... # 0x1
    ItemSceneChange          : ItemChange = ... # 0x2
    ItemVisibleHasChanged    : ItemChange = ... # 0x3
    ItemParentHasChanged     : ItemChange = ... # 0x4
    ItemOpacityHasChanged    : ItemChange = ... # 0x5
    ItemActiveFocusHasChanged: ItemChange = ... # 0x6
    ItemRotationHasChanged   : ItemChange = ... # 0x7
    ItemAntialiasingHasChanged: ItemChange = ... # 0x8
    ItemDevicePixelRatioHasChanged: ItemChange = ... # 0x9
    ItemEnabledHasChanged    : ItemChange = ... # 0xa

    class TransformOrigin(object): ...
    TopLeft                  : TransformOrigin = ... # 0x0
    Top                      : TransformOrigin = ... # 0x1
    TopRight                 : TransformOrigin = ... # 0x2
    Left                     : TransformOrigin = ... # 0x3
    Center                   : TransformOrigin = ... # 0x4
    Right                    : TransformOrigin = ... # 0x5
    BottomLeft               : TransformOrigin = ... # 0x6
    Bottom                   : TransformOrigin = ... # 0x7
    BottomRight              : TransformOrigin = ... # 0x8
...
class QQuickPaintedItem(PySide2.QtQuick.QQuickItem):
    ...
    FastFBOResizing          : PerformanceHint = ... # 0x1

    class PerformanceHints(object): ...

    class RenderTarget(object): ...
    Image                    : RenderTarget = ... # 0x0
    FramebufferObject        : RenderTarget = ... # 0x1
    InvertedYFramebufferObject: RenderTarget = ... # 0x2
...
class QQuickView(PySide2.QtQuick.QQuickWindow):
    ...
    SizeViewToRootObject     : ResizeMode = ... # 0x0
    SizeRootObjectToView     : ResizeMode = ... # 0x1
...
class QQuickWindow(PySide2.QtGui.QWindow):
    ...
    TextureHasAlphaChannel   : CreateTextureOption = ... # 0x1
    TextureHasMipmaps        : CreateTextureOption = ... # 0x2
    TextureOwnsGLTexture     : CreateTextureOption = ... # 0x4
    TextureCanUseAtlas       : CreateTextureOption = ... # 0x8
    TextureIsOpaque          : CreateTextureOption = ... # 0x10

    class CreateTextureOptions(object): ...

    class RenderStage(object): ...
    BeforeSynchronizingStage : RenderStage = ... # 0x0
    AfterSynchronizingStage  : RenderStage = ... # 0x1
    BeforeRenderingStage     : RenderStage = ... # 0x2
    AfterRenderingStage      : RenderStage = ... # 0x3
    AfterSwapStage           : RenderStage = ... # 0x4
    NoStage                  : RenderStage = ... # 0x5

    class SceneGraphError(object): ...
    ContextNotAvailable      : SceneGraphError = ... # 0x1

    class TextRenderType(object): ...
    QtTextRendering          : TextRenderType = ... # 0x0
    NativeTextRendering      : TextRenderType = ... # 0x1
...
class QSGAbstractRenderer(PySide2.QtCore.QObject):
    ...
    ClearColorBuffer         : ClearModeBit = ... # 0x1
    ClearDepthBuffer         : ClearModeBit = ... # 0x2
    ClearStencilBuffer       : ClearModeBit = ... # 0x4
...
class QSGGeometry(Shiboken.Object):
    ...
    UnknownAttribute         : AttributeType = ... # 0x0
    PositionAttribute        : AttributeType = ... # 0x1
    ColorAttribute           : AttributeType = ... # 0x2
    TexCoordAttribute        : AttributeType = ... # 0x3
    TexCoord1Attribute       : AttributeType = ... # 0x4
    TexCoord2Attribute       : AttributeType = ... # 0x5
    ...
    AlwaysUploadPattern      : DataPattern = ... # 0x0
    StreamPattern            : DataPattern = ... # 0x1
    DynamicPattern           : DataPattern = ... # 0x2
    StaticPattern            : DataPattern = ... # 0x3

    class DrawingMode(object): ...
    DrawPoints               : DrawingMode = ... # 0x0
    DrawLines                : DrawingMode = ... # 0x1
    DrawLineLoop             : DrawingMode = ... # 0x2
    DrawLineStrip            : DrawingMode = ... # 0x3
    DrawTriangles            : DrawingMode = ... # 0x4
    DrawTriangleStrip        : DrawingMode = ... # 0x5
    DrawTriangleFan          : DrawingMode = ... # 0x6
    ...
    class Type(object): ...
    ByteType                 : Type = ... # 0x1400
    UnsignedByteType         : Type = ... # 0x1401
    ShortType                : Type = ... # 0x1402
    UnsignedShortType        : Type = ... # 0x1403
    IntType                  : Type = ... # 0x1404
    UnsignedIntType          : Type = ... # 0x1405
    FloatType                : Type = ... # 0x1406
...
class QSGNode(Shiboken.Object):
    ...
    DirtySubtreeBlocked      : DirtyStateBit = ... # 0x80
    DirtyMatrix              : DirtyStateBit = ... # 0x100
    DirtyNodeAdded           : DirtyStateBit = ... # 0x400
    DirtyNodeRemoved         : DirtyStateBit = ... # 0x800
    DirtyGeometry            : DirtyStateBit = ... # 0x1000
    DirtyMaterial            : DirtyStateBit = ... # 0x2000
    DirtyOpacity             : DirtyStateBit = ... # 0x4000
    DirtyForceUpdate         : DirtyStateBit = ... # 0x8000
    DirtyUsePreprocess       : DirtyStateBit = ... # 0x2
    DirtyPropagationMask     : DirtyStateBit = ... # 0xc500

    class Flag(object): ...
    OwnedByParent            : Flag = ... # 0x1
    UsePreprocess            : Flag = ... # 0x2
    OwnsGeometry             : Flag = ... # 0x10000
    OwnsMaterial             : Flag = ... # 0x20000
    OwnsOpaqueMaterial       : Flag = ... # 0x40000
    IsVisitableNode          : Flag = ... # 0x1000000

    class Flags(object): ...

    class NodeType(object): ...
    BasicNodeType            : NodeType = ... # 0x0
    GeometryNodeType         : NodeType = ... # 0x1
    TransformNodeType        : NodeType = ... # 0x2
    ClipNodeType             : NodeType = ... # 0x3
    OpacityNodeType          : NodeType = ... # 0x4
    RootNodeType             : NodeType = ... # 0x5
    RenderNodeType           : NodeType = ... # 0x6
...
class QSGSimpleTextureNode(PySide2.QtQuick.QSGGeometryNode):
    ...
    NoTransform              : TextureCoordinatesTransformFlag = ... # 0x0
    MirrorHorizontally       : TextureCoordinatesTransformFlag = ... # 0x1
    MirrorVertically         : TextureCoordinatesTransformFlag = ... # 0x2
...
class QSGTexture(PySide2.QtCore.QObject):
    ...
    AnisotropyNone           : AnisotropyLevel = ... # 0x0
    Anisotropy2x             : AnisotropyLevel = ... # 0x1
    Anisotropy4x             : AnisotropyLevel = ... # 0x2
    Anisotropy8x             : AnisotropyLevel = ... # 0x3
    Anisotropy16x            : AnisotropyLevel = ... # 0x4

    class Filtering(object): ...
    None_                    : Filtering = ... # 0x0
    Nearest                  : Filtering = ... # 0x1
    Linear                   : Filtering = ... # 0x2

    class WrapMode(object): ...
    Repeat                   : WrapMode = ... # 0x0
    ClampToEdge              : WrapMode = ... # 0x1
    MirroredRepeat           : WrapMode = ... # 0x2
