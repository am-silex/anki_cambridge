...
class QtConcurrent(Shiboken.Object):
    ...
    UnorderedReduce          : ReduceOption = ... # 0x1
    OrderedReduce            : ReduceOption = ... # 0x2
    SequentialReduce         : ReduceOption = ... # 0x4

    class ReduceOptions(object): ...

    class ThreadFunctionResult(object): ...
    ThrottleThread           : ThreadFunctionResult = ... # 0x0
    ThreadFinished           : ThreadFunctionResult = ... # 0x1
