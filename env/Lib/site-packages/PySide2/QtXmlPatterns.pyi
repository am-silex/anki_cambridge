...
class QAbstractXmlNodeModel(Shiboken.Object):
    ...
    InheritNamespaces        : NodeCopySetting = ... # 0x1
    PreserveNamespaces       : NodeCopySetting = ... # 0x2

    class SimpleAxis(object): ...
    Parent                   : SimpleAxis = ... # 0x0
    FirstChild               : SimpleAxis = ... # 0x1
    PreviousSibling          : SimpleAxis = ... # 0x2
    NextSibling              : SimpleAxis = ... # 0x3
...
class QXmlNodeModelIndex(Shiboken.Object):
    ...
    Precedes                 : DocumentOrder = ... # -0x1
    Is                       : DocumentOrder = ... # 0x0
    Follows                  : DocumentOrder = ... # 0x1

    class NodeKind(object): ...
    Attribute                : NodeKind = ... # 0x1
    Comment                  : NodeKind = ... # 0x2
    Document                 : NodeKind = ... # 0x4
    Element                  : NodeKind = ... # 0x8
    Namespace                : NodeKind = ... # 0x10
    ProcessingInstruction    : NodeKind = ... # 0x20
    Text                     : NodeKind = ... # 0x40
...
class QXmlQuery(Shiboken.Object):
    ...
    XQuery10                 : QueryLanguage = ... # 0x1
    XSLT20                   : QueryLanguage = ... # 0x2
    XmlSchema11IdentityConstraintSelector: QueryLanguage = ... # 0x400
    XmlSchema11IdentityConstraintField: QueryLanguage = ... # 0x800
    XPath20                  : QueryLanguage = ... # 0x1000
