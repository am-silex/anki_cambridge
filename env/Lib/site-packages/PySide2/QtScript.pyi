...
class QScriptClass(Shiboken.Object):
    ...
    Callable                 : Extension = ... # 0x0
    HasInstance              : Extension = ... # 0x1

    class QueryFlag(object): ...
    HandlesReadAccess        : QueryFlag = ... # 0x1
    HandlesWriteAccess       : QueryFlag = ... # 0x2
...
class QScriptContext(Shiboken.Object):
    ...
    class Error(object): ...
    UnknownError             : Error = ... # 0x0
    ReferenceError           : Error = ... # 0x1
    SyntaxError              : Error = ... # 0x2
    TypeError                : Error = ... # 0x3
    RangeError               : Error = ... # 0x4
    URIError                 : Error = ... # 0x5

    class ExecutionState(object): ...
    NormalState              : ExecutionState = ... # 0x0
    ExceptionState           : ExecutionState = ... # 0x1
...
class QScriptContextInfo(Shiboken.Object):
    ...
    ScriptFunction           : FunctionType = ... # 0x0
    QtFunction               : FunctionType = ... # 0x1
    QtPropertyFunction       : FunctionType = ... # 0x2
    NativeFunction           : FunctionType = ... # 0x3
...
class QScriptEngine(PySide2.QtCore.QObject):
    ...
    ExcludeChildObjects      : QObjectWrapOption = ... # 0x1
    ExcludeSuperClassMethods : QObjectWrapOption = ... # 0x2
    ExcludeSuperClassProperties: QObjectWrapOption = ... # 0x4
    ExcludeSuperClassContents: QObjectWrapOption = ... # 0x6
    SkipMethodsInEnumeration : QObjectWrapOption = ... # 0x8
    ExcludeDeleteLater       : QObjectWrapOption = ... # 0x10
    ExcludeSlots             : QObjectWrapOption = ... # 0x20
    AutoCreateDynamicProperties: QObjectWrapOption = ... # 0x100
    PreferExistingWrapperObject: QObjectWrapOption = ... # 0x200

    class QObjectWrapOptions(object): ...

    class ValueOwnership(object): ...
    QtOwnership              : ValueOwnership = ... # 0x0
    ScriptOwnership          : ValueOwnership = ... # 0x1
    AutoOwnership            : ValueOwnership = ... # 0x2
...
class QScriptEngineAgent(Shiboken.Object):
    ...
    class Extension(object): ...
    DebuggerInvocationRequest: Extension = ... # 0x0
...
class QScriptString(Shiboken.Object):
    ...
    def toArrayIndex(self, ok:typing.Optional[bool]=...) -> int: ...
    def toString(self) -> str: ...
...
class QScriptValue(Shiboken.Object):
    ...
    ReadOnly                 : PropertyFlag = ... # 0x1
    Undeletable              : PropertyFlag = ... # 0x2
    SkipInEnumeration        : PropertyFlag = ... # 0x4
    PropertyGetter           : PropertyFlag = ... # 0x8
    PropertySetter           : PropertyFlag = ... # 0x10
    QObjectMember            : PropertyFlag = ... # 0x20
    KeepExistingFlags        : PropertyFlag = ... # 0x800
    UserRange                : PropertyFlag = ... # -0x1000000

    class PropertyFlags(object): ...

    class ResolveFlag(object): ...
    ResolveLocal             : ResolveFlag = ... # 0x0
    ResolvePrototype         : ResolveFlag = ... # 0x1
    ResolveScope             : ResolveFlag = ... # 0x2
    ResolveFull              : ResolveFlag = ... # 0x3
