...
class QAccelerometer(PySide2.QtSensors.QSensor):
    ...
    Combined                 : AccelerationMode = ... # 0x0
    Gravity                  : AccelerationMode = ... # 0x1
    User                     : AccelerationMode = ... # 0x2
...
class QAmbientLightReading(PySide2.QtSensors.QSensorReading):
    ...
    Undefined                : LightLevel = ... # 0x0
    Dark                     : LightLevel = ... # 0x1
    Twilight                 : LightLevel = ... # 0x2
    Light                    : LightLevel = ... # 0x3
    Bright                   : LightLevel = ... # 0x4
    Sunny                    : LightLevel = ... # 0x5
...
class QOrientationReading(PySide2.QtSensors.QSensorReading):
    ...
    Undefined                : Orientation = ... # 0x0
    TopUp                    : Orientation = ... # 0x1
    TopDown                  : Orientation = ... # 0x2
    LeftUp                   : Orientation = ... # 0x3
    RightUp                  : Orientation = ... # 0x4
    FaceUp                   : Orientation = ... # 0x5
    FaceDown                 : Orientation = ... # 0x6
...
class QSensor(PySide2.QtCore.QObject):
    ...
    FixedOrientation         : AxesOrientationMode = ... # 0x0
    AutomaticOrientation     : AxesOrientationMode = ... # 0x1
    UserOrientation          : AxesOrientationMode = ... # 0x2

    class Feature(object): ...
    Buffering                : Feature = ... # 0x0
    AlwaysOn                 : Feature = ... # 0x1
    GeoValues                : Feature = ... # 0x2
    FieldOfView              : Feature = ... # 0x3
    AccelerationMode         : Feature = ... # 0x4
    SkipDuplicates           : Feature = ... # 0x5
    AxesOrientation          : Feature = ... # 0x6
    PressureSensorTemperature: Feature = ... # 0x7
    Reserved                 : Feature = ... # 0x101
...
class QTapReading(PySide2.QtSensors.QSensorReading):
    ...
    Undefined                : TapDirection = ... # 0x0
    X                        : TapDirection = ... # 0x1
    Y                        : TapDirection = ... # 0x2
    Z                        : TapDirection = ... # 0x4
    X_Pos                    : TapDirection = ... # 0x11
    Y_Pos                    : TapDirection = ... # 0x22
    Z_Pos                    : TapDirection = ... # 0x44
    X_Neg                    : TapDirection = ... # 0x101
    Y_Neg                    : TapDirection = ... # 0x202
    Z_Neg                    : TapDirection = ... # 0x404
    X_Both                   : TapDirection = ... # 0x111
    Y_Both                   : TapDirection = ... # 0x222
    Z_Both                   : TapDirection = ... # 0x444
